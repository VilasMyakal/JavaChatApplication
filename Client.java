...
public class Client implements ActionListener{
    ...
    Client(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/shahid_profile.png"));
       ...
       JLabel name = new JLabel("Shahid Maniyar");
...
//      p2.setBackground(new Color(18,140,126));
    ...
    public static void main(String args[]){
        ...
        try{
            ...
            Socket s = new Socket("192.168.0.135",3333);
